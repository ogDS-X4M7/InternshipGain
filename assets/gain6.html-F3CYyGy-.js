...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="处理记录的合并单元格——行合并" tabindex="-1"><a class="header-anchor" href="#处理记录的合并单元格——行合并"><span>处理记录的合并单元格——行合并</span></a></h4><p>因为是行遍历，对行处理，所以如果出现行合并，就需要ranges记录信息，才能在进入需要被上一行合并的第二行时准确判断出需要合并，这部分代码主要用于处理跨行合并，之前已经读取过合并信息(<a href="#%E5%A4%84%E7%90%86%E5%BD%93%E5%89%8D%E5%8D%95%E5%85%83%E6%A0%BC%E7%9A%84%E5%90%88%E5%B9%B6%E5%B1%9E%E6%80%A7">下面</a>马上讲到)，后续遍历读取合并区域信息来判断是否需要合并，需要时填充<code>null</code>进入该行结果。 之所以说这里主要处理行合并，是因为列合并是在<a href="#%E6%B7%BB%E5%8A%A0%E5%8D%95%E5%85%83%E6%A0%BC%E5%80%BC%E5%B9%B6%E5%A4%84%E7%90%86colspan">下面</a>读取到单元格列合并信息就立刻处理掉的，只有跨行合并这种在行遍历情况下需要后续才处理的、处理比较迟钝的情况才会需要通过ranges合并信息来判断并处理。</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">ranges.forEach((range) =&gt; {</span>
...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="关于export-table-to-excel" tabindex="-1"><a class="header-anchor" href="#关于export-table-to-excel"><span>关于export_table_to_excel</span></a></h3><h3 id="关于s2ab" tabindex="-1"><a class="header-anchor" href="#关于s2ab"><span>关于s2ab</span></a></h3><p>这个方法的作用就是将二进制字符串转为<code>ArrayBuffer</code>，因为当使用<code>FileSaver.js</code>等库保存文件时，需要传入<code>Blob</code>对象（基于二进制数据），而非字符串</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">function s2ab(s: any) {</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意这里把表头、多级表头插入到data前面，说明表头数据也是放到data中一起进行处理的</p><h4 id="生成工作表-worksheet" tabindex="-1"><a class="header-anchor" href="#生成工作表-worksheet"><span>生成工作表（Worksheet）</span></a></h4><p>这部分主要是调用<code>sheet_from_array_of_arrays</code>函数，将<code>data</code>转换为<code>xlsx</code>所需的<code>Worksheet</code>对象，具体实现看关于<code>sheet_from_array_of_arrays</code>函数的<a href="#%E5%85%B3%E4%BA%8Esheet_from_array_of_arrays">讲解部分</a></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">const wsName = &#39;SheetJS&#39;</span>
...
<span class="line">  )</span>
<span class="line">}</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="后续要补充的讲解" tabindex="-1"><a class="header-anchor" href="#后续要补充的讲解"><span>后续要补充的讲解：</span></a></h2><p>export_table_to_excel函数；</p>`,37))])}const b=l(o,[["render",t]]),h=JSON.parse('{"path":"/guide/theFirstInternship/gain6.html","title":"收获三——实现Excel导出工具","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"核心依赖库","slug":"核心依赖库","link":"#核心依赖库","children":[]},{"level":2,"title":"各部分函数解析","slug":"各部分函数解析","link":"#各部分函数解析","children":[{"level":3,"title":"基本信息","slug":"基本信息","link":"#基本信息","children":[]},{"level":3,"title":"关于generateArray","slug":"关于generatearray","link":"#关于generatearray","children":[]},{"level":3,"title":"关于datenum","slug":"关于datenum","link":"#关于datenum","children":[]},{"level":3,"title":"关于sheet_from_array_of_arrays","slug":"关于sheet-from-array-of-arrays","link":"#关于sheet-from-array-of-arrays","children":[]},{"level":3,"title":"关于export_table_to_excel","slug":"关于export-table-to-excel","link":"#关于export-table-to-excel","children":[]},{"level":3,"title":"关于s2ab","slug":"关于s2ab","link":"#关于s2ab","children":[]},{"level":3,"title":"关于export_json_to_excel","slug":"关于export-json-to-excel","link":"#关于export-json-to-excel","children":[]}]},{"level":2,"title":"工具的总体实现","slug":"工具的总体实现","link":"#工具的总体实现","children":[]},{"level":2,"title":"后续要补充的讲解：","slug":"后续要补充的讲解","link":"#后续要补充的讲解","children":[]}],"git":{"updatedTime":1748538854000,"contributors":[{"name":"X4M7","username":"X4M7","email":"1415808154@qq.com","commits":2,"url":"https://github.com/X4M7"}],"changelog":[{"hash":"db31e1a3432e448ae4da377191cf77d861406181","time":1748538854000,"email":"1415808154@qq.com","author":"X4M7","message":"基本完成Excel导出工具的讲解"},{"hash":"e6c2e7c2c53288dc9cea12cbccf49263c237aedc","time":1748449321000,"email":"1415808154@qq.com","author":"X4M7","message":"项目一导出商品列表实现，Excel导出工具实现的部分讲解"}]},"filePathRelative":"guide/theFirstInternship/gain6.md"}');export{b as comp,h as data};
