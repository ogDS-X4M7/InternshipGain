import{_ as s,c as n,d as i,o as a}from"./app-Bk2rW08G.js";const l={};function d(r,e){return a(),n("div",null,e[0]||(e[0]=[i(`<h1 id="项目一——完善订单列表" tabindex="-1"><a class="header-anchor" href="#项目一——完善订单列表"><span>项目一——完善订单列表</span></a></h1><h2 id="需求与完成" tabindex="-1"><a class="header-anchor" href="#需求与完成"><span>需求与完成</span></a></h2><p>这次的需求仍然来自于项目一，不过是完善功能。原本项目已经实现了订单的导出功能，但现在想要增加信息，包括规格明细、积分、单价、成交单价、下单数量、收件人信息</p><p>基于之前完成的需求以及对整个导出封装文件的解读理解，很轻松就能修改原本的代码来增加新的功能</p><p>找到原本对excel方法的调用位置</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import(&#39;@/utils/excel&#39;).then((excel) =&gt; {</span>
