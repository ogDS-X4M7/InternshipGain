import{_ as n,c as e,d as a,o as i}from"./app-BslnYZnK.js";const l={};function c(p,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h1 id="taro小程序-react——基础知识与正常运行须知" tabindex="-1"><a class="header-anchor" href="#taro小程序-react——基础知识与正常运行须知"><span>Taro小程序+React——基础知识与正常运行须知</span></a></h1><p>这部分学习内容结合相应代码查看，目的是复习和记下使用方法，只供个人查看</p><p>大部分写法、使用方法都直接看代码就能了解，只做稍微的记录：</p><p>有类组件和函数组件两种写法，常用函数组件，两个写法都很简单，直接去看代码就知道，这里不多说。组件的调用很简单，到对应页面直接<code>import</code>，在<code>return</code>里直接使用即可</p><p>样式也很简单，基本没变，在组件、页面同目录下创建文件，然后<code>import &#39;./xxx.scss&#39;</code>引入即可</p><h2 id="状态管理-重点" tabindex="-1"><a class="header-anchor" href="#状态管理-重点"><span>状态管理（重点）</span></a></h2><p>状态管理仓库使用<code>mobx</code>，<code>store</code>文件夹下创建想要的仓库<code>js</code>文件，引入<code>mobx</code>：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">import { observable } from &#39;mobx&#39;</span>
