<template><div><h1 id="官网快速上手创建一个模版项目" tabindex="-1"><a class="header-anchor" href="#官网快速上手创建一个模版项目"><span>官网快速上手创建一个模版项目</span></a></h1>
<p>不必多言，官方网站<a href="https://vuepress.vuejs.org/zh/guide/getting-started.html" target="_blank" rel="noopener noreferrer">点击前往</a></p>
<h2 id="简洁版本" tabindex="-1"><a class="header-anchor" href="#简洁版本"><span>简洁版本</span></a></h2>
<p>Node.js v18.19.0+
