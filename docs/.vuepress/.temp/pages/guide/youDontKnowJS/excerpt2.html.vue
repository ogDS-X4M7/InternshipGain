<template><div><h1 id="你不知道的js-摘录-作用域与闭包" tabindex="-1"><a class="header-anchor" href="#你不知道的js-摘录-作用域与闭包"><span>你不知道的JS-摘录-作用域与闭包</span></a></h1>
<h2 id="摘自第一章-什么是作用域" tabindex="-1"><a class="header-anchor" href="#摘自第一章-什么是作用域"><span>摘自第一章 什么是作用域？</span></a></h2>
<p>事实上，在变量中存储值和取出值的能力，给程序赋予了 <em>状态</em>。</p>
<p>但是在我们的程序中纳入变量，引出了我们现在将要解决的最有趣的问题：这些变量 <em>存活</em> 在哪里？换句话说，它们被存储在哪儿？而且，最重要的是，我们的程序如何在需要它们的时候找到它们？</p>
<p>回答这些问题需要一组明确定义的规则，它定义如何在某些位置存储变量，以及如何在稍后找到这些变量。我们称这组规则为：<em>作用域</em>。</p>
<h2 id="摘自第一章-理解作用域" tabindex="-1"><a class="header-anchor" href="#摘自第一章-理解作用域"><span>摘自第一章-理解作用域</span></a></h2>
<h3 id="编译器术语" tabindex="-1"><a class="header-anchor" href="#编译器术语"><span>编译器术语</span></a></h3>
...
<h3 id="小测验" tabindex="-1"><a class="header-anchor" href="#小测验"><span>小测验</span></a></h3>
...
<li>
<p>找到所有的 LHS 查询（有3处！）。</p>
</li>
<li>
<p>找到所有的 RHS 查询（有4处！）。</p>
</li>
</ol>
<h3 id="小测验答案" tabindex="-1"><a class="header-anchor" href="#小测验答案"><span>小测验答案</span></a></h3>
<ol>
<li>
<p>找出所有的 LHS 查询（有3处！）。</p>
<p><strong><code v-pre>c = ..</code>, <code v-pre>a = 2</code>（隐含的参数赋值）和 <code v-pre>b = ..</code></strong></p>
</li>
<li>
<p>找出所有的 RHS 查询（有4处！）。</p>
<p><strong><code v-pre>foo(2..</code>, <code v-pre>= a;</code>, <code v-pre>a + ..</code> 和 <code v-pre>.. + b</code></strong></p>
</li>
</ol>
<h2 id="摘自第一章-错误" tabindex="-1"><a class="header-anchor" href="#摘自第一章-错误"><span>摘自第一章-错误</span></a></h2>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当 <code v-pre>b</code> 的 RHS 查询第一次发生时，它是找不到的。它被说成是一个“未声明”的变量，因为它在作用域中找不到。</p>
...
<p>相比之下，如果 <em>引擎</em> 在进行一个 LHS 查询，但到达了顶层（全局 <em>作用域</em>）都没有找到它，而且如果程序没有运行在“Strict模式”[^note-strictmode]下，那么这个全局 <em>作用域</em> 将会在 <strong>全局作用域中</strong> 创建一个同名的新变量，并把它交还给 <em>引擎</em>。</p>
...
<h2 id="摘自第二章-欺骗词法作用域" tabindex="-1"><a class="header-anchor" href="#摘自第二章-欺骗词法作用域"><span>摘自第二章-欺骗词法作用域</span></a></h2>
...
<h2 id="摘自附录a" tabindex="-1"><a class="header-anchor" href="#摘自附录a"><span>摘自附录A</span></a></h2>
...
<h2 id="摘自第三章-隐藏于普通作用域" tabindex="-1"><a class="header-anchor" href="#摘自第三章-隐藏于普通作用域"><span>摘自第三章-隐藏于普通作用域</span></a></h2>
...
<h2 id="摘自第三章-函数作为作用域" tabindex="-1"><a class="header-anchor" href="#摘自第三章-函数作为作用域"><span>摘自第三章-函数作为作用域</span></a></h2>
...
<h2 id="摘自第三章-块级作为作用域" tabindex="-1"><a class="header-anchor" href="#摘自第三章-块级作为作用域"><span>摘自第三章-块级作为作用域</span></a></h2>
...
<h2 id="摘自第四章-函数优先" tabindex="-1"><a class="header-anchor" href="#摘自第四章-函数优先"><span>摘自第四章-函数优先</span></a></h2>
...
<h2 id="摘自第五章-事实真相" tabindex="-1"><a class="header-anchor" href="#摘自第五章-事实真相"><span>摘自第五章-事实真相</span></a></h2>
...
<h2 id="摘自第五章-现在我能看到了" tabindex="-1"><a class="header-anchor" href="#摘自第五章-现在我能看到了"><span>摘自第五章-现在我能看到了</span></a></h2>
...
<details class="hint-container details"><summary>个人复习总结</summary>
<p>这一章节还讲了非常多内容，包括块级作用域的详解，模块的使用，<code v-pre>ES6</code>的模块，因为看下来已经都在我熟悉掌握的范围内了，就不再摘录，直接摘抄复习的总结部分了</p>
</details>
<p>对于那些还蒙在鼓里的人来说，闭包就像在 JavaScript 内部被隔离开的魔法世界，只有很少一些最勇敢的灵魂才能到达。但是它实际上只是一个标准的，而且几乎明显的事实 —— 我们如何在函数即是值，而且可以被随意传递的词法作用域环境中编写代码，</p>
<p><strong>闭包就是当一个函数即使是在它的词法作用域之外被调用时，也可以记住并访问它的词法作用域。</strong></p>
<p>如果我们不能小心地识别它们和它们的工作方式，闭包可能会绊住我们，例如在循环中。但它们也是一种极其强大的工具，以各种形式开启了像 <em>模块</em> 这样的模式。</p>
<p>模块要求两个关键性质：1）一个被调用的外部包装函数，来创建外围作用域。2）这个包装函数的返回值必须包含至少一个内部函数的引用，这个函数才拥有包装函数内部作用域的闭包。</p>
<p>现在我们看到了闭包在我们的代码中无处不在，而且我们有能力识别它们，并为了我们自己的利益利用它们！</p>
</div></template>
